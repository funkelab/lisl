...
experiment_folder = "/nrs/funke/wolfs2/lisl/experiments/unet_combinations_3/"
...
all_stats = []
for setup_number in range(num_setups):

    setup_folder = experiment_folder + f"01_train/setup_t{setup_number:04}"
...
for th in ["0.5", "0.6", "0.8", "0.9"]:
    for score_name in ['precision', 'recall',
        ...
        ax.figure.savefig(f'{score_name}_{th}.png')
        plt.close("all")
